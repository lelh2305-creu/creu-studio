...
*Small Prints, Big Waves.*`
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&w=1200&q=80',
    category: 'MARKETING',
    author: 'CREU Studio',
...
`;
  ...
  console.log(`Wrote MDX file: ${post.slug}.mdx`);
}

console.log('All 5 MDX posts generated successfully!');
